...
public:
    ...
    iterator begin() { return iterator(listeTransaction); }
    iterator end() { return iterator(listeTransaction + nbTrans); }
    using const_iterator = const Transaction*;
    const_iterator begin() const { return listeTransaction; }
    const_iterator end() const { return listeTransaction + nbTrans; }
    const_iterator cbegin() const { return listeTransaction; }
    const_iterator cend() const { return listeTransaction + nbTrans; }
