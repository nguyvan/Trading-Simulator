...
public:
    ...
    void setEvolutionCours(EvolutionCours* e){evolutionCours = e;}
...
public:
    void setlookBackPeriod(unsigned int s){lookBackPeriod = s;}
    void setoverboughtBound(double o){oversoldBound = o;}
    void setoversoldBound(double o){oversoldBound = o;}
    double getoverboughtBound(){return overboughtBound;}
    double getoversoldBound(){return oversoldBound;}
